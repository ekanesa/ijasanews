<nav class="bg-white/50 drop-shadow-md backdrop-blur-sm fixed top-0 z-50 left-0 w-full" x-data="{ isOpen: false }">
        ...
        <div class="flex h-20 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    ...
                    <a href="/" class="router-link-active router-link-exact-active items-center flex gap-2 px-2"
                        ...
                        <p class="font-semibold text-3xl">iJASA</p>
                    </a>
                </div>
            </div>
            <!-- Navigasi Desktop -->
            <div class="hidden md:block flex-grow">
                <div class="ml-10 flex items-baseline justify-center gap-10 font-light">
                    ...
                    <a href="/dukungan" class="text-black hover:bg-transparent hover:text-red-600 rounded-md">Dukungan</a>
    ...
    <div class="md:hidden" x-show="isOpen">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="{{ route('article.index') }}" class="text-black hover:bg-transparent hover:text-red-600 rounded-md">Berita</a>
            <a href="/dukungan" class="block text-black hover:bg-transparent hover:text-red-600 rounded-md">Dukungan</a>
            <a href="/Partnership" class="block text-black hover:bg-transparent hover:text-red-600 rounded-md">Partnership</a>
            <a href="/galery" class="block text-black hover:bg-transparent hover:text-red-600 rounded-md">Gallery</a>
        </div>
        <div class="px-5">
            <button type="button"
